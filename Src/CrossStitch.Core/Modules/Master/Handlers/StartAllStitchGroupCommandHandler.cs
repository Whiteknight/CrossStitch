...
namespace CrossStitch.Core.Modules.Master.Handlers
{
    ...
    {
        public StartAllStitchGroupCommandHandler(string nodeId, MasterDataRepository data, JobManager jobManager, IStitchRequestHandler stitches, IClusterMessageSender sender)
